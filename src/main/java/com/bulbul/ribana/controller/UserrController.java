...
public interface UserrController extends BaseController<Userr, Long> {
    ...
    ResponseEntity<List<CustomUserr>> findByParams(@RequestParam Map<String, String> params) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException;
