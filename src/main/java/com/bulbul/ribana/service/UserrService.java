...
public interface UserrService extends BaseService<Userr, Long> {
    ...
    List<CustomUserr> findByParams(Map<String, Object> params) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException, NoSuchFieldException;
