package com.bulbul.ribana.constants;
...
public class CommonConstants {
    ...
    public static final String DB_STRING_SINGLE_QUOTES = "'";

    public static final String DB_BETWEEN = " BETWEEN ";

    public static final String DB_KEY_SEPARATOR = "_";
